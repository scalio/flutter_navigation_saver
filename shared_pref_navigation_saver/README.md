...
This library should be used if you have some special way of serializing arguments into the string and back. Also do not forget to check [general readme](../README.md).


## How does core module work:

1. It uses the [core module](../)
